					...
					if(existe.equals("si")){           // EL USUARIO SI EXISTE
						...
						while(!finalizar){
							...
							break;
                                ...
                                else if(palabra[0].equals("2")){// registro
                                    System.out.println("registro");
                                    System.out.println(palabra);
                                 
                                
                                    String nombre=palabra[1];
                                    String apellido=palabra[2];
                                    String correo=palabra[3];
                                    String contraseña=palabra[4];
                                    
                                    usuario = new Autenticar_Usuario(correo,contraseña);
                                
                                    int r = this.usuario.Registrar(nombre,apellido,correo,contraseña);
